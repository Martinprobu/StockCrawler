...
def run_url(gain, log, limit_time_start, start_name) :
    ...
    for list in res['list']:
        ...
        if create_time > limit_time_start and name in start_name :
...
if __name__ == '__main__':
    while 1 == 1:
        ...
        gain = 'monthly_gain'
        log = '../log/xueqiu202206_monthly_gain.log'
        limit_monthly_time_start = run_url(gain, log, limit_monthly_time_start, start_name)
        time.sleep(random.random() * 2)

        # gain = 'annualized_gain_rate'
        # log = '../log/xueqiu202206_year_gain.log'
        # limit_year_time_start = run_url(gain, log, limit_year_time_start, start_name)
